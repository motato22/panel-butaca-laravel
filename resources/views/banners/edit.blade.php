                ...
                <div class="col-12 pt-4">
                    ...
                    @if ($errors->any())
                        <div class="alert alert-danger">
                            <b>No se pudo actualizar el banner</b>:
                            <ul>
                    ...
                    >
                        ...
                        <div class="form-row">
                            <div class="col-12 col-md-8 col-lg-6 text-center offset-md-2 offset-lg-3">
                                ...
                                @if($banner->imagen)
                                    <img 
                                        src="{{ asset('storage/uploads/banners/' . $banner->imagen) }}"
                                        alt="Imagen actual" 
                                        class="img-thumbnail max-height-6 mb-3"
                                    >
                                @else
                                    <img 
                                        class="img-thumbnail max-height-6 mb-3" 
                                ...
                                <small id="banner_form_file_help" class="help-text">
                                    Si subes una nueva imagen, reemplazará la existente.
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input
                                    ...
                                    value="{{ old('descripcion', $banner->descripcion) }}"
                                >
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                >
                                    <option value="0" 
                                        @selected(old('ubicacion_imagen', $banner->ubicacion_imagen) == '0')>
                                        Llenar banner (texto ignorado)
                                    </option>
                                    <option value="1" 
                                        @selected(old('ubicacion_imagen', $banner->ubicacion_imagen) == '1')>
                                        Lado Izquierdo (texto requerido)
                                    </option>
                                    <option value="2" 
                                        @selected(old('ubicacion_imagen', $banner->ubicacion_imagen) == '2')>
                            ...
                            <div class="form-group col-md-6">
                                <label for="ubicacion" class="required">
                                ...
                                >
                                    <option value="0" 
                                        @selected(old('ubicacion', $banner->ubicacion) == '0')>
                                        Arriba
                                    </option>
                                    <option value="1" 
                                        @selected(old('ubicacion', $banner->ubicacion) == '1')>
                                        Abajo
                                    </option>
                                </select>
                                <small class="help-text">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input
                                    ...
                                    data-format="Y-m-d"
                                    data-lang="es"
                                    value="{{ old('fecha_inicio', optional($banner->fecha_inicio)->format('Y-m-d')) }}"
                                >
                                <small class="help-text">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input
                                    ...
                                    data-format="Y-m-d"
                                    data-lang="es"
                                    value="{{ old('fecha_fin', optional($banner->fecha_fin)->format('Y-m-d')) }}"
                                >
                                <small class="help-text">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                >
                                    <option value="1" 
                                        @selected(old('activo', $banner->activo) == '1')>
                                        Sí
                                    </option>
                                    <option value="0" 
                                        @selected(old('activo', $banner->activo) == '0')>
                                        No
                                    </option>
                                </select>
                                <small class="help-text">
