                ...
                <div class="col-md-6 m-auto text-white p-t-20 p-b-90">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-b-0 bg-transparent ol-breadcrum float-right">
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{url('banners/publicitarios')}}"></a>Formulario</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12 m-b-30">
                <div class="card">
                    ...
                    <div class="card-body">
                       <form id="form-data" action="{{url('banners/publicitarios/'.($item ? 'update' : 'save'))}}" onsubmit="return false;" enctype="multipart/form-data" method="POST" autocomplete="off" data-ajax-type="ajax-form" data-column="0" data-refresh="" data-redirect="1" data-table_id="example3" data-container_id="table-container">
                            <div class="row">
	                            <div class="form-group col-md-12 text-center">
	                                <label class="avatar-input" style="max-width: 300px;">
	                                    ...
	                                    {{-- </span> --}}
	                                    <input type="file" name="foto" class="avatar-file-picker {{$item->foto ? '' : 'not-empty'}} file image" data-target="avatar-profile-img" data-msg="Foto de banner">
	                                </label>
	                            </div>
                            ...
                            <div class="form-group m-t-15">
                                <a href="{{url('banners/publicitarios')}}"><button type="button" class="btn btn-primary">Regresar</button></a>
