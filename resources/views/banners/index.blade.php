        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 m-auto text-white p-t-40 p-b-90">
                    ...
                    <p class="opacity-75">
                        Aquí podrá visualizar y modificar los banners publicitarios de la app web.
                    </p>
                </div>
                <div class="col-md-4 m-auto text-white p-t-40 p-b-90 general-info" data-url="{{url("banners/publicitarios")}}" data-refresh="table" data-el-loader="card">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-controls">
                            ...
                            {{-- <a href="{{url('banners/comprar')}}"><button class="btn btn-success" type="button"> <i class="mdi mdi-open-in-new"></i> Nuevo banner</button></a> --}}
                        </div>
